...
function redirectsTo($action = "defaut")
{
    ...
    $lesActions["addContree"] = "addContreeController.php";
    $lesActions["deleteContree"] = "deleteContreeController.php";
    $lesActions["gestionLegende"] = "gestionLegendeController.php";
    $lesActions["addLegende"] = "addLegendeController.php";
    $lesActions["deleteLegende"] = "deleteLegendeController.php";
    ...
    $lesActions["moderateCommentaire"] = "moderateComController.php";
